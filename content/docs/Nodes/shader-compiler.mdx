...
<ImageZoom src="/img/shaders/materialcount.png" width={350} height={0} />

### Material Length

* Get number of material shaders to be compiled
<ImageZoom src="/img/shaders/materiallength.png" width={350} height={0} />

### Niagara Count

* Get number of niagara system compiled
<ImageZoom src="/img/shaders/niagaracount.png" width={350} height={0} />

### Niagara Length

* Get number of niagara system to be compiled
<ImageZoom src="/img/shaders/niagaralength.png" width={350} height={0} />
...
<ImageZoom src="/img/shaders/start.png" width={240} height={0} />

### Stop

* Stop shader compilation
<ImageZoom src="/img/shaders/stop.png" width={240} height={0} />
...
<ImageZoom src="/img/shaders/onstarted.png" width={215} height={0} />

### On Shader Compiled

* Event triggered when one shader has been compiled.
<ImageZoom src="/img/shaders/onshadercompiled.png" width={265} height={0} />

### On Fisnish

* Event triggered when all shaders compilation has ben finished.
<ImageZoom src="/img/shaders/onfinish.png" width={202} height={0} />